...
from gradcam.svd_on_activations import get_2d_projection
...
class BaseCAM:
    ...
    def forward(self, input_tensor, input_text, target_category=None, eigen_smooth=False):
        if self.cuda:
        ...
        output = self.activations_and_grads(input_tensor, input_text)
        print(output)
        output = output[1]
        print(output)
