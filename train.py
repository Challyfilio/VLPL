...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.COOP.CTX_INIT = "classification: a photo of a, a type of. I like it."  # initialization words #############################
    # cfg.TRAINER.COOP.CTX_INIT = ""
    cfg.TRAINER.COOP.TASK_DESCRIBE = "scene classification:"
    ...
    cfg.Tokens_Num = 1  # VPE
    # visual prompt
    cfg.Prompt_Size = 30  # 30
